    ...
    <div class="form-container">
        ...
        <form method="POST" action="">
            ...
            <div class="block">
                ...
                <select class="form-select form-select-lg mb-2" name="abilities[]" multiple <?php if ($errors['abilities']) {
                                                                                                print 'class="error"';
                                                                                            } ?>>
                    <option value="endless life" <?php $arr = explode(',', $values['abilities']);
                                                    if ($arr != '') {
